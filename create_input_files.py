...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default="flickr30k", help='Default MSCOCO 14 Dataset.')
    parser.add_argument('--karpathy_json_path', default="./dataset/dataset_flickr30k.json",
