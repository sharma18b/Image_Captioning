...
def train(args, train_loader, encoder, decodera, decoderb, decoderc, criterion, mse , encoder_optimizer, decodera_optimizer, decoderb_optimizer, decoderc_optimizer, epoch):
    """
    ...
    for i, (imgs, caps, caplens) in enumerate(train_loader):
        ...
        if i % args.print_freq == 0:
            # writer.add_scalar("LossA/train", lossa, epoch)
            # writer.add_scalar("LossA/train", lossb, epoch)
            # writer.add_scalar("LossA/train", lossc, epoch)
...
def validate(args, val_loader, encoder, decodera,decoderb,decoderc, criterion,mse):
    """
    ...
    # metricsab = get_eval_score([[hypothesesa]], [hypothesesb])
    # metricsbc = get_eval_score([[hypothesesb]], [hypothesesc])
    # metricsca = get_eval_score([[hypothesesc]], [hypothesesa])

    print("For A references vs hypothesis \n EVA LOSS: {} TOP-5 Accuracy {} BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
          (lossesa.avg, top5accsa.avg,  metricsa["Bleu_1"],  metricsa["Bleu_2"],  metricsa["Bleu_3"],  metricsa["Bleu_4"],
           metricsa["ROUGE_L"], metricsa["CIDEr"]))
    print("For B references vs hypothesis \n EVA LOSS: {} TOP-5 Accuracy {} BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
          (lossesb.avg, top5accsb.avg,  metricsb["Bleu_1"],  metricsb["Bleu_2"],  metricsb["Bleu_3"],  metricsb["Bleu_4"],
           metricsb["ROUGE_L"], metricsb["CIDEr"]))
    print("For c references vs hypothesis \n EVA LOSS: {} TOP-5 Accuracy {} BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
          (lossesc.avg, top5accsc.avg,  metricsc["Bleu_1"],  metricsc["Bleu_2"],  metricsc["Bleu_3"],  metricsc["Bleu_4"],
           metricsc["ROUGE_L"], metricsc["CIDEr"]))
    # print("Scores between A & B Hypothesis \n BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
    #       ( metricsab["Bleu_1"],  metricsab["Bleu_2"],  metricsab["Bleu_3"],  metricsab["Bleu_4"],
    #        metricsab["ROUGE_L"], metricsab["CIDEr"]))
    # print("Scores between B & C Hypothesis \n BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
    #       ( metricsbc["Bleu_1"],  metricsbc["Bleu_2"],  metricsbc["Bleu_3"], metricsbc["Bleu_4"],
    #        metricsbc["ROUGE_L"], metricsbc["CIDEr"]))
    # print("Scores between C & A Hypothesis \n BLEU-1 {} BLEU2 {} BLEU3 {} BLEU-4 {} ROUGE_L {} CIDEr {} \n".format
    #       ( metricsca["Bleu_1"],  metricsca["Bleu_2"],  metricsca["Bleu_3"],  metricsca["Bleu_4"],
    #        metricsca["ROUGE_L"], metricsca["CIDEr"]))
